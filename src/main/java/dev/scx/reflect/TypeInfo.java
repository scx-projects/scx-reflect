...
///
/// [Class] / [ParameterizedType]  -->  [ClassInfo]
///
/// [Class] (isPrimitive = true)  -->  [PrimitiveTypeInfo]
///
/// [GenericArrayType] / [Class] (isArray = true)  -->  [ArrayTypeInfo]
///
/// [TypeVariable]  -->  尝试推导或回退到上界 --> [TypeInfo]
///
/// [WildcardType]  -->  回退到上界 --> [TypeInfo]
///
/// @author scx567888
/// @version 0.0.1
